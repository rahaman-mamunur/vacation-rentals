...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !email || !password || !cpassword) {
      setError(true);
      message.error(
        'Please fill all fields required and ensure passwords match.'
      );
      return;
    }
    ...
    try {
      ...
      await updateUserProfile(
        name,
        'https://i.ibb.co/8zNGYt1/photo-1633332755192-727a05c4013d-q-80-w-1000-auto-format-fit-crop-ixlib-rb-4-0.jpg'
      );
          ...
          <div className="flex-1 p-8 bg-white rounded-lg shadow-md space-y-6">
            ...
            {success && (
              <div className="text-green-500 text-sm">
                {' '}
                <Success success="User Registered Successfully" /> You can now
                log in.
              </div>
            )}
          </div>
