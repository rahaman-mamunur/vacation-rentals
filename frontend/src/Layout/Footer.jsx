const Footer =()=>{
    ...
    return(
        <>
        <footer className="footer items-center mt-10 p-10  bg-neutral text-neutral-content">
  <aside className="items-center grid-flow-col ml-20">
  ...
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end mr-20">
