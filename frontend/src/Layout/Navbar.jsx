    ...
    <>
      <div className="navbar mb-10 bg-slate-600 text-white flex justify-between items-center px-4 py-3">
        <div className="navbar-start flex-grow flex items-center">
          <Link
            to="/"
            className="btn btn-ghost text-xl ml-20 flex items-center text-white font-bold"
          >
            Vacation Rentals
          </Link>
        </div>
        <div className="navbar-end mr-20 mt-2">
          {' '}
          <ul className="flex items-center">{navOptions}</ul>
        </div>
      </div>
    </>
  );
